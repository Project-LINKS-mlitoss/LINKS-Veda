...
CROSS_JOB_NAME = os.getenv('CROSS_JOB_NAME')
...
def cross(request):
    ...
    try:
        ...
        print('[CROSS][INCOMING REQUEST]',req)
...
def trigger_job(data):
    print("[CROSS] calling trigger job")
    try:
        # Create the job client
        jobs_client = JobsClient()

        # Get the job path
        job_path = jobs_client.job_path(PROJECT_ID, REGION, CROSS_JOB_NAME)
